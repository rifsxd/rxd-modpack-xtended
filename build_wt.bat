...
xcopy /s /y "src_wt\*" "pack_wt\pc\Data\"
...
type .\%build% > ./pack_wt/pc/data/%modv%
...
xcopy /s /y "src_wt\*" "pack_wt\mobile\Data\"
...
type .\%build% > ./pack_wt/mobile/data/%modv%
...
rd /s /q "pack_wt\mobile-lesta\Data\"
...
xcopy /s /y "src_wt\*" "pack_wt\mobile-lesta\Data\"
...
type .\%build% > ./pack_wt/mobile-lesta/data/%modv%

ECHO ------------------------------------------

REM Does Cleaning Of Old Cache For MOBILE-EMBED.

rd /s /q "pack_wt\mobile-embed\Data\"
...
xcopy /s /y "src_wt\*" "pack_wt\mobile-embed\Data\"
...
type .\%build% > ./pack_wt/mobile-embed/data/%modv%
